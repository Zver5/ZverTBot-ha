...
* диагностику состояния соединения с VPS;
* отображение последней успешной проверки, ошибок и следующей попытки;
* настройку интервала обновления;
* безопасную задержку повторных SSH-подключений после ошибок.
...
Текущая версия интеграции: **1.2.2**.
